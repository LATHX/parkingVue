<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <BusinessInvoiceForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></BusinessInvoiceForm>
   <template #footer>
...
<script lang="ts" setup>
  ...
  import BusinessInvoiceForm from './BusinessInvoiceForm.vue'
