<template>
  <div class="p-2">
    ...
    <!--      </div>-->
    <!--引用表格-->
    <BasicTable @register="registerTable" :rowSelection="rowSelection" style="height: 75vh">
      <!--插槽:table标题-->
      <template #tableTitle>
        <a-button type="primary" v-auth="'parking:parking_merchant:add'" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增 </a-button>
        <a-button type="primary" v-auth="'parking:parking_merchant:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls">
          导出
        </a-button>
        <j-upload-button type="primary" v-auth="'parking:parking_merchant:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls"
          >导入
        </j-upload-button>
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'parking:parking_merchant:deleteBatch'"
            >批量操作
