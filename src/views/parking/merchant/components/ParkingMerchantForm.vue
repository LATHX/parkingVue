          ...
          <a-row>
						...
						<a-col :span="24">
							<a-form-item label="城市" v-bind="validateInfos.city" id="ParkingMerchantForm-city" name="city">
								<a-input v-model:value="formData.city" placeholder="请输入城市"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="是否可用" v-bind="validateInfos.status" id="ParkingMerchantForm-status" name="status">
								<a-input v-model:value="formData.status" placeholder="请输入是否可用"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="父账号" v-bind="validateInfos.parentId" id="ParkingMerchantForm-parentId" name="parentId">
								<a-input v-model:value="formData.parentId" placeholder="请输入父账号"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
          </a-row>
        </a-form>
