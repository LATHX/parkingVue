...
<script lang="ts" name="parking-parkingOrder" setup>
  ...
  import { columns, superQuerySchema } from './ParkingOrderInfo.data';
  import {
    list,
    deleteOne,
    batchDelete,
  ...
  import OrderListStats from '../components/OrderListStats.vue';
  ...
  const [registerTable, { reload }, { selectedRowKeys }] =
    listPage.tableContext;
