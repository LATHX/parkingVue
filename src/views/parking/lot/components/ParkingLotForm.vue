          ...
          <a-row :gutter="24">
            <a-col :span="8">
              <a-form-item label="车场名称" v-bind="validateInfos.parkingName" id="ParkingLotForm-parkingName" name="parkingName">
                <a-input v-model:value="formData.parkingName" placeholder="请输入车场名称" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="8">
            ...
            <!-- <a-col :span="8">
              <a-form-item label="所属区域" v-bind="validateInfos.city" id="ParkingLotForm-city" name="city">
                <j-dict-select-tag v-model:value="formData.city" dictCode="city" placeholder="请选择所属区域" allow-clear />
              </a-form-item>
            </a-col> -->
            <a-col :span="8">
              <a-form-item label="车场地址" v-bind="validateInfos.address" id="ParkingLotForm-address" name="address">
                <a-input v-model:value="formData.address" placeholder="请输入车场地址" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="8">
            ...
            <a-col :span="8">
              <a-form-item label="车场其它标签" v-bind="validateInfos.parkingOtherTags" id="ParkingLotForm-parkingOtherTags" name="parkingOtherTags">
                <j-dict-select-tag
                  mode="multiple"
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="8">
              <a-form-item label="发送短信" v-bind="validateInfos.isSupportSms" id="ParkingLotForm-isSupportSms" name="isSupportSms">
                <j-dict-select-tag v-model:value="formData.isSupportSms" dictCode="yn" placeholder="请选择" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="8">
            ...
            <a-col :span="8">
              <a-form-item label="是否可用优惠券" v-bind="validateInfos.isSupportCoupon" id="ParkingLotForm-isSupportCoupon" name="isSupportCoupon">
                <j-dict-select-tag v-model:value="formData.isSupportCoupon" dictCode="yn" placeholder="请选择" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="8">
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="8">
              <a-form-item label="排序" v-bind="validateInfos.orderNum" id="ParkingLotForm-orderNum" name="orderNum">
                <a-input-number v-model:value="formData.orderNum" placeholder="请输入" style="width: 100%" />
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
...
<script lang="ts" setup>
  ...
  // Adjust labelCol and wrapperCol to be more compact or vertical if needed, but horizontal works with enough span.
  // The design has labels on the left.
  const labelCol = ref<any>({ xs: { span: 24 }, sm: { span: 8 } });
  const wrapperCol = ref<any>({ xs: { span: 24 }, sm: { span: 16 } });
  const confirmLoading = ref<boolean>(false);
  //表单验证
  const validatorRules = reactive({
    parkingName: [{ required: true, message: '请输入车场名称!' }],
    parkingLocationId: [{ required: true, message: '请选择关联站点!' }],
    merchantId: [{ required: true, message: '请选择关联商户!' }],
    city: [{ required: true, message: '请选择所属区域!' }],
